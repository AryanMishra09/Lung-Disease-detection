  ...
  const features = [
    {
      ...
      description:
        "Powered by DenseNet121 neural network trained on extensive chest X-ray datasets for accurate multi-label classification.",
    },
    {
      icon: <Eye className="w-8 h-8" />,
      title: "Grad-CAM Visualization",
      description:
        "Advanced gradient-weighted class activation mapping highlights affected regions with clinical precision.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Multi-Label Detection",
      description:
        "Simultaneously detects multiple lung conditions including COVID-19, TB, Pneumonia, and Lung Opacity.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Clinical Support Tool",
      description:
        "Designed as an early-stage diagnostic support system to assist healthcare professionals.",
    },
  ];
  ...
  const diseases = [
    {
      name: "COVID-19",
      color: "bg-red-500",
      description: "Coronavirus lung infection patterns",
    },
    {
      name: "Tuberculosis",
      color: "bg-blue-500",
    ...
    },
    {
      name: "Pneumonia",
      color: "bg-yellow-500",
      description: "Lung inflammation and infection",
    },
    {
      name: "Lung Opacity",
      color: "bg-purple-500",
      description: "Abnormal lung density areas",
    },
    {
      name: "Normal",
      color: "bg-green-500",
      description: "Healthy lung tissue",
    },
  ];
      ...
      <section className="relative py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-200 mb-10 max-w-3xl mx-auto leading-relaxed">
            Cutting-edge AI technology for automated chest X-ray analysis,
            providing rapid and accurate detection of multiple lung conditions
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-200 text-lg max-w-2xl mx-auto">
              Built with state-of-the-art deep learning models and computer
              vision techniques
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-200 text-lg max-w-2xl mx-auto">
              Our AI model can identify multiple lung conditions simultaneously
              with high precision
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {diseases.map((disease, index) => (
              ...
              >
                <div
                  className={`w-4 h-4 ${disease.color} rounded-full mb-4`}
                ></div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200">
                        Gradient-weighted class activation mapping for
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200">
                        High-performance API for real-time inference and
                        processing
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-amber-100 leading-relaxed">
                  This AI diagnostic support tool is designed for educational
                  and research purposes. It should not replace professional
                  medical diagnosis or clinical judgment. Always consult
